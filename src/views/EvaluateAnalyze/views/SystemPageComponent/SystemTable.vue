<template>
    <el-container style="width: 100%;height: 100%;background-color: #ffffff">
        <el-row style="text-align: center">
           <div class="heading-2">生态文明体系设计</div>
        </el-row>
        <el-row style="width:100%;height: 95%">
            <el-col :offset="1" class="SystemPageCol">
                <el-card shadow="hover" style="height: 90%;width: 90%;text-align: center">
                    ...
                    <el-row  style="text-align: center;padding: 10px">
                        <el-button @click="AddButtonClick" type="primary" style="color:#ffffff">添加</el-button>
                        <el-button @click="DeleteButtonClick" type="danger"  style="color:#ffffff">删除</el-button>
                    </el-row>
                    <el-row>
                    ...
                    <el-row  style="text-align: center;padding: 10px">
                        <el-button @click="ConfirmButtonClick" type="primary" style="color:#ffffff">确定</el-button>
                        <el-button @click="CancelButtonClick" type="danger"  style="color:#ffffff">取消</el-button>
                    </el-row>
                </el-card>
            </el-col>
            <el-col  class="SystemPageCol">
                <el-card shadow="hover" style="height: 90%;width: 90%;text-align: center">
                    ...
                    <el-row  style="text-align: center;padding-top: 10px">
                        <el-button @click=CalculateClick() type="primary" round style="color:#ffffff">计算</el-button>
                        <el-button @click=ReCalculateClick() type="danger" round style="color:#ffffff">重置</el-button>
                    </el-row>
                </el-card>
            </el-col>
        </el-row>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            CancelButtonClick(){
                this.WeightDataTable=this.SDGsIndex;
                this.rowMergeArrs = this.rowMergeHandle(this.needMergeArr, this.WeightDataTable);
            },
